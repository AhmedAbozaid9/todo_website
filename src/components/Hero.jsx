...
const Hero = () => {
  return (
      <Section color="bg-pastelYellow" style="flex md:flex-row flex-col items-center mx-auto justify-around">
       <div className=" flex flex-col">
         <h1 className="md:text-7xl sm:text-5xl text-3xl font-semibold md:leading-[90px] sm:leading-[50px]">Manage All <br /> Your Tasks <br /> With Ease</h1>
